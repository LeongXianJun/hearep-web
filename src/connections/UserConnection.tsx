class UserConnection {
  ...
  public mockUserDB: User[] = [
    { id: 1, username: 'Dr. JoneLeong', password: '123123123', email: 'leongxianjun@1utar.my', type: 'medicalStaff', detail: { fullname: 'Jone Leong', age: 21, gender: 'M' } },
    { 
      id: 1, username: 'Xian Jun', password: '', email: 'leongxianjun@utar.my', type: 'patient',
      detail: { 
    ...
    { id: 2, username: 'Cecil Shea', password: '', email: '', type: 'patient', detail: { fullname: 'Cecil Shea', age: 25, gender: 'F' } },
    { id: 3, username: 'Terri Woodard', password: '', email: '', type: 'patient', detail: { fullname: 'Terri Woodard', age: 42, gender: 'M' } },
    { id: 4, username: 'Vinay Burt', password: '', email: '', type: 'patient', detail: { fullname: 'Vinay Burt', age: 35, gender: 'M' } },
    { id: 5, username: 'Alessandro Barron', password: '', email: '', type: 'patient', detail: { fullname: 'Alessandro Barron', age: 32, gender: 'M' } },
    { id: 6, username: 'Shreya Mejia', password: '', email: '', type: 'patient', detail: { fullname: 'Shreya Mejia', age: 28, gender: 'F' } },
    { id: 7, username: 'Leyton Guevara', password: '', email: '', type: 'patient', detail: { fullname: 'Leyton Guevara', age: 26, gender: 'F' } },
    { id: 8, username: 'Yuvray Lenno', password: '', email: '', type: 'patient', detail: { fullname: 'Yuvray Lenno', age: 18, gender: 'F' } },
    { id: 9, username: 'Teejay Velaquez', password: '', email: '', type: 'patient', detail: { fullname: 'Teejay Velaquez', age: 50, gender: 'M' } },
    { id: 10, username: 'Jax Pierce', password: '', email: '', type: 'patient', detail: { fullname: 'Jax Pierce', age: 39, gender: 'M' } },
  ]
